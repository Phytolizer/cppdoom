...
#ifndef EZ_BOOM_RANDOM_HH
#define EZ_BOOM_RANDOM_HH
...
enum class PrClass
{
    ...
    Misc,
    AllInOne,
    // TODO(kyle) MBF classes
    NUM_PR_CLASS
};

struct Rng
{
    std::array<unsigned int, static_cast<std::size_t>(PrClass::NUM_PR_CLASS)> seed;
    int randIndex;
    int pRandIndex;
};
...
static constexpr std::array<unsigned char, 256> RANDOM_TABLE{
