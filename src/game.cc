...
void game::reloadDefaults()
{
    ...
    {
        doomstat::compatibility_level = static_cast<doomstat::CompLevel>(argMeta.complevel.value());
    }
    ...
    {
        for (std::size_t i = 0; i < static_cast<std::size_t>(doomstat::CompFlag::COMP_TOTAL); ++i)
        {
...
void game::compatibility()
{
    static constexpr std::array levels{
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_TELEFRAG,
                                                {doomstat::CompLevel::Mbf, doomstat::CompLevel::Mbf}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_DROPOFF,
                                                {doomstat::CompLevel::Mbf, doomstat::CompLevel::Mbf}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_VILE,
                                                {doomstat::CompLevel::Boom202, doomstat::CompLevel::Mbf}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_PAIN,
                                                {doomstat::CompLevel::Boom202, doomstat::CompLevel::Mbf}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_SKULL,
                                                {doomstat::CompLevel::Boom202, doomstat::CompLevel::Mbf}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_BLAZING,
                                                {doomstat::CompLevel::Boom202, doomstat::CompLevel::Mbf}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_DOORLIGHT,
                                                {doomstat::CompLevel::Boom202, doomstat::CompLevel::Mbf}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_MODEL,
                                                {doomstat::CompLevel::Boom202, doomstat::CompLevel::Mbf}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_GOD,
                                                {doomstat::CompLevel::Boom202, doomstat::CompLevel::Mbf}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_FALLOFF,
                                                {doomstat::CompLevel::Mbf, doomstat::CompLevel::Mbf}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_FLOORS,
                                                {doomstat::CompLevel::Boom, doomstat::CompLevel::Mbf}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_SKYMAP,
                                                {doomstat::CompLevel::Mbf, doomstat::CompLevel::Mbf}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_PURSUIT,
                                                {doomstat::CompLevel::Mbf, doomstat::CompLevel::Mbf}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_DOORSTUCK,
                                                {doomstat::CompLevel::Boom202, doomstat::CompLevel::Mbf}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_STAYLIFT,
                                                {doomstat::CompLevel::Mbf, doomstat::CompLevel::Mbf}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_ZOMBIE,
                                                {doomstat::CompLevel::LxDoom, doomstat::CompLevel::Mbf}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_STAIRS,
                                                {doomstat::CompLevel::Boom202, doomstat::CompLevel::Mbf}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_INFCHEAT,
                                                {doomstat::CompLevel::Mbf, doomstat::CompLevel::Mbf}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_ZEROTAGS,
                                                {doomstat::CompLevel::Boom202, doomstat::CompLevel::Mbf}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_MOVEBLOCK,
                                                {doomstat::CompLevel::LxDoom, doomstat::CompLevel::PrBoom2}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_RESPAWN,
                                                {doomstat::CompLevel::PrBoom2, doomstat::CompLevel::PrBoom2}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_SOUND,
                                                {doomstat::CompLevel::Boom, doomstat::CompLevel::PrBoom3}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_666,
                                                {doomstat::CompLevel::UltDoom, doomstat::CompLevel::PrBoom4}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_SOUL,
                                                {doomstat::CompLevel::PrBoom4, doomstat::CompLevel::PrBoom4}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_MASKEDANIM,
                                                {doomstat::CompLevel::Doom1666, doomstat::CompLevel::PrBoom4}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_OUCHFACE,
                                                {doomstat::CompLevel::PrBoom1, doomstat::CompLevel::PrBoom6}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_MAXHEALTH,
                                                {doomstat::CompLevel::Boom, doomstat::CompLevel::PrBoom6}},
        std::pair<doomstat::CompFlag, CompInfo>{doomstat::CompFlag::COMP_TRANSLUCENCY,
                                                {doomstat::CompLevel::Boom, doomstat::CompLevel::PrBoom6}},
    };
    ...
    if (demo::isDemoPlayback())
    {
        if (argMeta.emulate.has_value())
        {
            ...
            {
                comp.state = (argMeta.emulate.value() >= comp.minVer && argMeta.emulate.value() < comp.maxVer);
            }
        }
    }
    ...
    if (!prboomCompatibility[static_cast<std::size_t>(PrBoomCompatibilityFlag::FORCE_LXDOOM_DEMO_COMPATIBILITY)].state)
    {
    ...
    if (!doomstat::mbfFeatures())
    {
        doomstat::monster_infighting = doomstat::MonsterInfightingLevel::OtherSpecies;
