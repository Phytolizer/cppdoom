...
extern constinit std::array<const char* const, to_underlying(SpriteEnum::NUMSPRITES) + 1> sprnames;
...
extern constinit std::array<MobjInfo, to_underlying(MobjType::NUMMOBJTYPES)> mobjinfo;
...
#define OLDBFG_2FRAMES(x) OLDBFG_1FRAME(x) OLDBFG_1FRAME(static_cast<int>(x) + 1)
...
extern constinit map::map<StateEnum, State, to_underlying(StateEnum::NUMSTATES)> states;
